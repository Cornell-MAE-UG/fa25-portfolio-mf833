...
I chose to model a YETI water bottle because it is something I use it  every day, and I wanted to reverse-engineer an object that feels simple but actually has a surprising level of engineering detail. 

I created a fully parametric 3D CAD model that accurately captures both the external industrial design and the internal functional features. I went detailed enough to recreate the raised YETI brand lettering on the outer surface, matching its proportions and curvature so the text blends cleanly with the cylindrical body.

![Shaded rendering of earlier version]({{ "/assets/images/YetiCap.jpg" | relative_url }}){: .inline-image-r style="width: 200px"}
