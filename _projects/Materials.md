...
![Wheel assembly CAD]({{ "/assets/images/Materials/MaterialsCAD.jpg" | relative_url }}){: .inline-image-r style="width: 260px;" }
...
![Wheel assembly CAD]({{ "/assets/images/Materials/Diagram.jpg" | relative_url }}){: .inline-image-l style="width: 260px;" }
...
![Wheel assembly CAD]({{ "/assets/images/Materials/MaxPrincipalstress.jpg" | relative_url }}){: .inline-image-r style="width: 260px;" }


A key part of the project was comparing maximum principle stresses obtained from beam theory with the stress predicted by the finite element model. 
